        ...
        if st.sidebar.checkbox("Login"):
            ...
            if result:
                ...
                if task == "Adicionar Post":
                    st.subheader("Faça Seu Post")
                    b_author = st.text_input("Nome do Autor",max_chars=50)
                    b_title = st.text_input("Titulo")
                    b_article = st.text_area("Artigo",height=200)
                    b_post_date = st.date_input("Data")
                    ...
                    if dataset:
                        ...
                        if export_as_pdf:
                            ...
                            html = create_download_link('Banco de dados Tabela.html', "Rivertemp_Tabela")
                        ...
                        ax.set_title('Evolução Diaria da Temperatura Média por Hora\n')
